...
export const OFFERINGS = [
  {
    ...
    description: "Long-form articles that go beyond surface-level tutorials. Understand the why behind every engineering decision.",
    icon: "blog",
  },
  {
    title: "System Design Breakdowns",
    description: "Detailed walkthroughs of real-world architectures — from data pipelines to distributed systems.",
    icon: "system",
  },
  {
    title: "Engineering Insights",
    description: "Patterns, anti-patterns, and hard-won lessons from building production systems at scale.",
    icon: "insight",
  },
  {
    title: "Consulting & Architecture",
    description: "Hands-on guidance for teams navigating complex technical decisions and platform evolution.",
    icon: "consulting",
  },
] as const;
...
export const FEATURED_ARTICLES = [
  {
    ...
    description: "Breaking apart a monolith doesn't mean you've escaped it. Learn the patterns that keep teams coupled across service boundaries.",
    tags: ["Architecture", "Microservices"],
    readTime: "12 min read",
  },
  {
    title: "The Hidden Cost of Premature Abstraction",
    description: "When DRY becomes a liability. A deep look at how over-engineering early destroys velocity and creates accidental complexity.",
    tags: ["Engineering", "Patterns"],
    readTime: "8 min read",
  },
  {
    title: "Event Sourcing in Practice: Beyond the Hype",
    description: "A pragmatic guide to event-driven architectures — when they shine, when they don't, and how to implement them without drowning in complexity.",
